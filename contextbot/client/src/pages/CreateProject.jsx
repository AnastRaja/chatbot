            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="flex gap-4 pt-4 border-t border-slate-200">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="flex-1 bg-blue-600 hover:bg-blue-700 text-white py-3.5 rounded-xl font-semibold disabled:opacity-50 transition shadow-lg shadow-blue-600/20 hover:-translate-y-0.5"
                    >
