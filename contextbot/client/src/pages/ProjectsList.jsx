        ...
        <div className="p-8 max-w-7xl mx-auto">
            <div className="flex justify-between items-center mb-10">
                ...
                <button
                    ...
                    className="bg-gray-900 hover:bg-gray-800 text-white px-5 py-2.5 rounded-lg font-medium transition shadow-sm hover:shadow flex items-center gap-2 text-sm"
                >
                        ...
                        <div key={project.id} className="bg-white rounded-xl shadow-[0_2px_10px_-3px_rgba(0,0,0,0.05)] border border-slate-100 hover:shadow-md transition-all duration-200 group flex flex-col">
                            ...
                            <div className="p-4 border-t border-slate-50 bg-slate-50/30 flex items-center gap-2">
                                <button
                                    ...
                                    className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 bg-gray-900 text-white rounded-lg text-sm font-medium hover:bg-gray-800 transition shadow-sm"
                                >
